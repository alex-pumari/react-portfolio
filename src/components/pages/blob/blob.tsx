...
export function Blob ({ className, size = "md", shape = "a" }: BlobProps) {
  ...
  if(shape === "a") {
    return (
      <svg viewBox="0 0 640 480" className={blobClasses} aria-hidden={true}>
        <g>
          <path
  ...
  if(shape === "b") {
    return (
      <svg viewBox="196 0 444 250" className={blobClasses} aria-hidden={true}>
        <g>
          <path
  ...
  if(shape === "c") {
    return (
      <svg viewBox="0 910 1920 170" className={blobClasses} aria-hidden={true}>
        <g>
          <path
